...
extension TelegramAPI {
    ...
    */
    public class User: Codable {
        ...
        public init(id: Int, is_bot: Bool, first_name: String, last_name: String? = nil, username: String? = nil, language_code: String? = nil, is_premium: Bool? = nil, added_to_attachment_menu: Bool? = nil, can_join_groups: Bool? = nil, can_read_all_group_messages: Bool? = nil, supports_inline_queries: Bool? = nil, can_connect_to_business: Bool? = nil, has_main_web_app: Bool? = nil, has_topics_enabled: Bool? = nil, allows_users_to_create_topics: Bool? = nil, can_manage_bots: Bool? = nil) {
            self.id = id
            self.is_bot = is_bot
...
extension TelegramAPI {
    ...
    */
    public class ReplyParameters: Codable {
        ...
        public let message_id: Int
        /** Integer or String | Optional. If the message to be replied to is from a different chat, unique identifier for the chat or username of the channel (in the format @channelusername). Not supported for messages sent on behalf of a business account and messages from channel direct messages chats. */
...
extension TelegramAPI {
    ...
    */
    public class PollOption: Codable {
        ...
        public init(persistent_id: String, text: String, text_entities: Array<MessageEntity>? = nil, voter_count: Int, added_by_user: User? = nil, added_by_chat: Chat? = nil, addition_date: Int? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class Poll: Codable {
        ...
        public init(id: String, question: String, question_entities: Array<MessageEntity>? = nil, options: Array<PollOption>, total_voter_count: Int, is_closed: Bool, is_anonymous: Bool, type: String, allows_multiple_answers: Bool, allows_revoting: Bool, correct_option_ids: Array<Int>? = nil, explanation: String? = nil, explanation_entities: Array<MessageEntity>? = nil, open_period: Int? = nil, close_date: Int? = nil, description: String? = nil, description_entities: Array<MessageEntity>? = nil) {
            self.id = id
...
extension TelegramAPI {
    ...
    */
    public class ChatPermissions: Codable {
        ...
        public let can_add_web_page_previews: Bool?
        /** Boolean | Optional. True, if the user is allowed to edit their own tag */
        public let can_edit_tag: Bool?
...
extension TelegramAPI {
    ...
    */
    public class BotCommandScopeChat: Codable {
        ...
        public let type: String
        /** Integer or String | Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername). Channel direct messages chats and channel chats aren't supported. */
        public let chat_id: Either2<Int, String>
...
extension TelegramAPI {
    ...
    */
    public class ChatOwnerLeft: Codable {
        /** User | Optional. The user which will be the new owner of the chat if the previous owner does not return to the chat */
...
extension TelegramAPI {
    ...
    public struct SendMediaGroupParams: Codable {
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, media: Either4<Array<InputMediaAudio>, Array<InputMediaDocument>, Array<InputMediaPhoto>, Array<InputMediaVideo>>, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public struct SendPollParams: Codable {
        /** String | Unique identifier of the business connection on behalf of which the message will be sent */
        public let business_connection_id: String?
        /** Integer or String | Unique identifier for the target chat or username of the target channel (in the format @channelusername). Polls can't be sent to channel direct messages chats. */
        public let chat_id: Either2<Int, String>
        /** Integer | Unique identifier for the target message thread (topic) of a forum; for forum supergroups and private chats of bots with forum topic mode enabled only */
        public let message_thread_id: Int?
        /** String | Poll question, 1-300 characters */
        ...
        public let question_entities: Array<MessageEntity>?
        /** Array of InputPollOption | A JSON-serialized list of 2-12 answer options */
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, question: String, question_parse_mode: String? = nil, question_entities: Array<MessageEntity>? = nil, options: Array<InputPollOption>, is_anonymous: Bool? = nil, type: String? = nil, allows_multiple_answers: Bool? = nil, allows_revoting: Bool? = nil, shuffle_options: Bool? = nil, allow_adding_options: Bool? = nil, hide_results_until_closes: Bool? = nil, correct_option_ids: Array<Int>? = nil, explanation: String? = nil, explanation_parse_mode: String? = nil, explanation_entities: Array<MessageEntity>? = nil, open_period: Int? = nil, close_date: Int? = nil, is_closed: Bool? = nil, description: String? = nil, description_parse_mode: String? = nil, description_entities: Array<MessageEntity>? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: Either4<InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply>? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.question = question
...
extension TelegramAPI {
    ...
    public struct SendChecklistParams: Codable {
        ...
        public init(business_connection_id: String, chat_id: Int, checklist: InputChecklist, disable_notification: Bool? = nil, protect_content: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.checklist = checklist
            self.disable_notification = disable_notification
...
extension TelegramAPI {
    ...
    public struct SendMessageDraftParams: Codable {
        ...
        public init(chat_id: Int, message_thread_id: Int? = nil, draft_id: Int, text: String, parse_mode: String? = nil, entities: Array<MessageEntity>? = nil) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
...
extension TelegramAPI {
    ...
    public struct SendChatActionParams: Codable {
        ...
        public let business_connection_id: String?
        /** Integer or String | Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername). Channel chats and channel direct messages chats aren't supported. */
        public let chat_id: Either2<Int, String>
...
extension TelegramAPI {
    ...
    public struct LeaveChatParams: Codable {
        /** Integer or String | Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername). Channel direct messages chats aren't supported; leave the corresponding channel instead. */
        public let chat_id: Either2<Int, String>
...
extension TelegramAPI {
    ...
    public struct SendGiftParams: Codable {
        ...
        public let user_id: Int?
        /** Integer or String | Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @channelusername) that will receive the gift. */
        public let chat_id: Either2<Int, String>?
...
extension TelegramAPI {
    ...
    public struct VerifyChatParams: Codable {
        /** Integer or String | Unique identifier for the target chat or username of the target channel (in the format @channelusername). Channel direct messages chats can't be verified. */
        public let chat_id: Either2<Int, String>
        /** String | Custom description for the verification; 0-70 characters. Must be empty if the organization isn't allowed to provide a custom verification description. */
        public let custom_description: String?
...
extension TelegramAPI {
    ...
    public struct EditMessageChecklistParams: Codable {
        ...
        public init(business_connection_id: String, chat_id: Int, message_id: Int, checklist: InputChecklist, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_id = message_id
            self.checklist = checklist
...
extension TelegramAPI {
    ...
    public struct SendGameParams: Codable {
        /** String | Unique identifier of the business connection on behalf of which the message will be sent */
        public let business_connection_id: String?
        /** Integer | Unique identifier for the target chat. Games can't be sent to channel direct messages chats and channel chats. */
        public let chat_id: Int
        /** Integer | Unique identifier for the target message thread (topic) of a forum; for forum supergroups and private chats of bots with forum topic mode enabled only */
        public let message_thread_id: Int?
