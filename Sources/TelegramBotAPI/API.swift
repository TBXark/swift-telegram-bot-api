...
extension TelegramAPI {
    ...
    */
    public class Update: Codable {
        ...
        public let guest_message: Message?
        ...
        public init(update_id: Int, message: Message? = nil, edited_message: Message? = nil, channel_post: Message? = nil, edited_channel_post: Message? = nil, business_connection: BusinessConnection? = nil, business_message: Message? = nil, edited_business_message: Message? = nil, deleted_business_messages: BusinessMessagesDeleted? = nil, guest_message: Message? = nil, message_reaction: MessageReactionUpdated? = nil, message_reaction_count: MessageReactionCountUpdated? = nil, inline_query: InlineQuery? = nil, chosen_inline_result: ChosenInlineResult? = nil, callback_query: CallbackQuery? = nil, shipping_query: ShippingQuery? = nil, pre_checkout_query: PreCheckoutQuery? = nil, purchased_paid_media: PaidMediaPurchased? = nil, poll: Poll? = nil, poll_answer: PollAnswer? = nil, my_chat_member: ChatMemberUpdated? = nil, chat_member: ChatMemberUpdated? = nil, chat_join_request: ChatJoinRequest? = nil, chat_boost: ChatBoostUpdated? = nil, removed_chat_boost: ChatBoostRemoved? = nil, managed_bot: ManagedBotUpdated? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class User: Codable {
        ...
        public let supports_guest_queries: Bool?
        ...
        public let has_topics_enabled: Bool?
        /** Boolean | Optional. True, if the bot allows users to create and delete topics in private chats. Returned only in getMe. */
        public let allows_users_to_create_topics: Bool?
        /** Boolean | Optional. True, if other bots can be created to be controlled by the bot. Returned only in getMe. */
        public let can_manage_bots: Bool?

        public init(id: Int, is_bot: Bool, first_name: String, last_name: String? = nil, username: String? = nil, language_code: String? = nil, is_premium: Bool? = nil, added_to_attachment_menu: Bool? = nil, can_join_groups: Bool? = nil, can_read_all_group_messages: Bool? = nil, supports_guest_queries: Bool? = nil, supports_inline_queries: Bool? = nil, can_connect_to_business: Bool? = nil, has_main_web_app: Bool? = nil, has_topics_enabled: Bool? = nil, allows_users_to_create_topics: Bool? = nil, can_manage_bots: Bool? = nil) {
            self.id = id
            self.is_bot = is_bot
...
extension TelegramAPI {
    ...
    */
    public class Chat: Codable {
        ...
        public let is_direct_messages: Bool?

        public init(id: Int, type: ChatType, title: String? = nil, username: String? = nil, first_name: String? = nil, last_name: String? = nil, is_forum: Bool? = nil, is_direct_messages: Bool? = nil) {
            self.id = id
            self.type = type
            self.title = title
            self.username = username
...
extension TelegramAPI {
    ...
    */
    public class ChatFullInfo: Codable {
        ...
        public let accepted_gift_types: AcceptedGiftTypes
        ...
        public let first_profile_audio: Audio?
        ...
        public let unique_gift_colors: UniqueGiftColors?
        /** Integer | Optional. The number of Telegram Stars a general user have to pay to send a message to the chat */
        public let paid_message_star_count: Int?

        public init(id: Int, type: ChatType, title: String? = nil, username: String? = nil, first_name: String? = nil, last_name: String? = nil, is_forum: Bool? = nil, is_direct_messages: Bool? = nil, accent_color_id: Int, max_reaction_count: Int, photo: ChatPhoto? = nil, active_usernames: Array<String>? = nil, birthdate: Birthdate? = nil, business_intro: BusinessIntro? = nil, business_location: BusinessLocation? = nil, business_opening_hours: BusinessOpeningHours? = nil, personal_chat: Chat? = nil, parent_chat: Chat? = nil, available_reactions: Array<ReactionType>? = nil, background_custom_emoji_id: String? = nil, profile_accent_color_id: Int? = nil, profile_background_custom_emoji_id: String? = nil, emoji_status_custom_emoji_id: String? = nil, emoji_status_expiration_date: Int? = nil, bio: String? = nil, has_private_forwards: Bool? = nil, has_restricted_voice_and_video_messages: Bool? = nil, join_to_send_messages: Bool? = nil, join_by_request: Bool? = nil, description: String? = nil, invite_link: String? = nil, pinned_message: Message? = nil, permissions: ChatPermissions? = nil, accepted_gift_types: AcceptedGiftTypes, can_send_paid_media: Bool? = nil, slow_mode_delay: Int? = nil, unrestrict_boost_count: Int? = nil, message_auto_delete_time: Int? = nil, has_aggressive_anti_spam_enabled: Bool? = nil, has_hidden_members: Bool? = nil, has_protected_content: Bool? = nil, has_visible_history: Bool? = nil, sticker_set_name: String? = nil, can_set_sticker_set: Bool? = nil, custom_emoji_sticker_set_name: String? = nil, linked_chat_id: Int? = nil, location: ChatLocation? = nil, rating: UserRating? = nil, first_profile_audio: Audio? = nil, unique_gift_colors: UniqueGiftColors? = nil, paid_message_star_count: Int? = nil) {
            self.id = id
            self.type = type
            self.title = title
            self.username = username
...
extension TelegramAPI {
    ...
    */
    public class Message: Codable {
        ...
        public let guest_query_id: String?
        ...
        public let reply_to_message: Message?
        ...
        public let paid_star_count: Int?
        ...
        public let chat_owner_left: ChatOwnerLeft?
        /** ChatOwnerChanged | Optional. Service message: chat owner has changed */
        public let chat_owner_changed: ChatOwnerChanged?
        ...
        public let checklist_tasks_done: ChecklistTasksDone?
        /** ChecklistTasksAdded | Optional. Service message: tasks were added to a checklist */
        public let checklist_tasks_added: ChecklistTasksAdded?
        ...
        public let direct_message_price_changed: DirectMessagePriceChanged?
        ...
        public init(message_id: Int, message_thread_id: Int? = nil, direct_messages_topic: DirectMessagesTopic? = nil, from: User? = nil, sender_chat: Chat? = nil, sender_boost_count: Int? = nil, sender_business_bot: User? = nil, sender_tag: String? = nil, date: Int, guest_query_id: String? = nil, business_connection_id: String? = nil, chat: Chat, forward_origin: MessageOrigin? = nil, is_topic_message: Bool? = nil, is_automatic_forward: Bool? = nil, reply_to_message: Message? = nil, external_reply: ExternalReplyInfo? = nil, quote: TextQuote? = nil, reply_to_story: Story? = nil, reply_to_checklist_task_id: Int? = nil, reply_to_poll_option_id: String? = nil, via_bot: User? = nil, guest_bot_caller_user: User? = nil, guest_bot_caller_chat: Chat? = nil, edit_date: Int? = nil, has_protected_content: Bool? = nil, is_from_offline: Bool? = nil, is_paid_post: Bool? = nil, media_group_id: String? = nil, author_signature: String? = nil, paid_star_count: Int? = nil, text: String? = nil, entities: Array<MessageEntity>? = nil, link_preview_options: LinkPreviewOptions? = nil, suggested_post_info: SuggestedPostInfo? = nil, effect_id: String? = nil, animation: Animation? = nil, audio: Audio? = nil, document: Document? = nil, live_photo: LivePhoto? = nil, paid_media: PaidMediaInfo? = nil, photo: Array<PhotoSize>? = nil, sticker: Sticker? = nil, story: Story? = nil, video: Video? = nil, video_note: VideoNote? = nil, voice: Voice? = nil, caption: String? = nil, caption_entities: Array<MessageEntity>? = nil, show_caption_above_media: Bool? = nil, has_media_spoiler: Bool? = nil, checklist: Checklist? = nil, contact: Contact? = nil, dice: Dice? = nil, game: Game? = nil, poll: Poll? = nil, venue: Venue? = nil, location: Location? = nil, new_chat_members: Array<User>? = nil, left_chat_member: User? = nil, chat_owner_left: ChatOwnerLeft? = nil, chat_owner_changed: ChatOwnerChanged? = nil, new_chat_title: String? = nil, new_chat_photo: Array<PhotoSize>? = nil, delete_chat_photo: Bool? = nil, group_chat_created: Bool? = nil, supergroup_chat_created: Bool? = nil, channel_chat_created: Bool? = nil, message_auto_delete_timer_changed: MessageAutoDeleteTimerChanged? = nil, migrate_to_chat_id: Int? = nil, migrate_from_chat_id: Int? = nil, pinned_message: MaybeInaccessibleMessage? = nil, invoice: Invoice? = nil, successful_payment: SuccessfulPayment? = nil, refunded_payment: RefundedPayment? = nil, users_shared: UsersShared? = nil, chat_shared: ChatShared? = nil, gift: GiftInfo? = nil, unique_gift: UniqueGiftInfo? = nil, gift_upgrade_sent: GiftInfo? = nil, connected_website: String? = nil, write_access_allowed: WriteAccessAllowed? = nil, passport_data: PassportData? = nil, proximity_alert_triggered: ProximityAlertTriggered? = nil, boost_added: ChatBoostAdded? = nil, chat_background_set: ChatBackground? = nil, checklist_tasks_done: ChecklistTasksDone? = nil, checklist_tasks_added: ChecklistTasksAdded? = nil, direct_message_price_changed: DirectMessagePriceChanged? = nil, forum_topic_created: ForumTopicCreated? = nil, forum_topic_edited: ForumTopicEdited? = nil, forum_topic_closed: ForumTopicClosed? = nil, forum_topic_reopened: ForumTopicReopened? = nil, general_forum_topic_hidden: GeneralForumTopicHidden? = nil, general_forum_topic_unhidden: GeneralForumTopicUnhidden? = nil, giveaway_created: GiveawayCreated? = nil, giveaway: Giveaway? = nil, giveaway_winners: GiveawayWinners? = nil, giveaway_completed: GiveawayCompleted? = nil, managed_bot_created: ManagedBotCreated? = nil, paid_message_price_changed: PaidMessagePriceChanged? = nil, poll_option_added: PollOptionAdded? = nil, poll_option_deleted: PollOptionDeleted? = nil, suggested_post_approved: SuggestedPostApproved? = nil, suggested_post_approval_failed: SuggestedPostApprovalFailed? = nil, suggested_post_declined: SuggestedPostDeclined? = nil, suggested_post_paid: SuggestedPostPaid? = nil, suggested_post_refunded: SuggestedPostRefunded? = nil, video_chat_scheduled: VideoChatScheduled? = nil, video_chat_started: VideoChatStarted? = nil, video_chat_ended: VideoChatEnded? = nil, video_chat_participants_invited: VideoChatParticipantsInvited? = nil, web_app_data: WebAppData? = nil, reply_markup: InlineKeyboardMarkup? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class MessageEntity: Codable {
        ...
        public let date_time_format: String?

        public init(type: MessageEntityType, offset: Int, length: Int, url: String? = nil, user: User? = nil, language: String? = nil, custom_emoji_id: String? = nil, unix_time: Int? = nil, date_time_format: String? = nil) {
            self.type = type
            self.offset = offset
            self.length = length
            self.url = url
...
extension TelegramAPI {
    ...
    */
    public class ReplyParameters: Codable {
        ...
        public let message_id: Int
        /** Integer or String | Optional. If the message to be replied to is from a different chat, unique identifier for the chat or username of the bot, supergroup or channel in the format @username. Not supported for messages sent on behalf of a business account and messages from channel direct messages chats. */
        ...
        public let checklist_task_id: Int?
        /** String | Optional. Persistent identifier of the specific poll option to be replied to */
        public let poll_option_id: String?

        public init(message_id: Int, chat_id: Either2<Int, String>? = nil, allow_sending_without_reply: Bool? = nil, quote: String? = nil, quote_parse_mode: String? = nil, quote_entities: Array<MessageEntity>? = nil, quote_position: Int? = nil, checklist_task_id: Int? = nil, poll_option_id: String? = nil) {
            self.message_id = message_id
...
extension TelegramAPI {
    ...
    */
    public class LivePhoto: Codable {
        ...
        public init(photo: Array<PhotoSize>? = nil, file_id: String, file_unique_id: String, width: Int, height: Int, duration: Int, mime_type: String? = nil, file_size: Int? = nil) {
            self.photo = photo
            self.file_id = file_id
            self.file_unique_id = file_unique_id
            self.width = width
...
extension TelegramAPI {
    ...
    */
    public class VideoQuality: Codable {
        /** String | Identifier for this file, which can be used to download or reuse the file */
        public let file_id: String
        /** String | Unique identifier for this file, which is supposed to be the same over time and for different bots. Can't be used to download or reuse the file. */
        public let file_unique_id: String
        ...
        public init(file_id: String, file_unique_id: String, width: Int, height: Int, codec: String, file_size: Int? = nil) {
            self.file_id = file_id
            self.file_unique_id = file_unique_id
            self.width = width
            self.height = height
...
extension TelegramAPI {
    ...
    */
    public class Video: Codable {
        ...
        public let cover: Array<PhotoSize>?
        ...
        public let qualities: Array<VideoQuality>?
        /** String | Optional. Original filename as defined by the sender */
        public let file_name: String?
        /** String | Optional. MIME type of the file as defined by the sender */
        public let mime_type: String?
        ...
        public init(file_id: String, file_unique_id: String, width: Int, height: Int, duration: Int, thumbnail: PhotoSize? = nil, cover: Array<PhotoSize>? = nil, start_timestamp: Int? = nil, qualities: Array<VideoQuality>? = nil, file_name: String? = nil, mime_type: String? = nil, file_size: Int? = nil) {
            self.file_id = file_id
            self.file_unique_id = file_unique_id
            self.width = width
            self.height = height
...
extension TelegramAPI {
    ...
    */
    public indirect enum PaidMedia: Codable {
        case paidMediaLivePhoto(PaidMediaLivePhoto)
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(PaidMediaLivePhoto.self) {
                self = .paidMediaLivePhoto(value)
            }
            else if let value = try? container.decode(PaidMediaPhoto.self) {
                self = .paidMediaPhoto(value)
            }
            else if let value = try? container.decode(PaidMediaPreview.self) {
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.singleValueContainer()
            switch self {
                case .paidMediaLivePhoto(let value):
                    try container.encode(value)
...
extension TelegramAPI {
    ...
    */
    public class PaidMediaLivePhoto: Codable {
        /** String | Type of the paid media, always "live_photo" */
        public let type: String
        /** LivePhoto | The photo */
        public let live_photo: LivePhoto

        public init(type: String, live_photo: LivePhoto) {
            self.type = type
            self.live_photo = live_photo
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class PollMedia: Codable {
        ...
        public init(animation: Animation? = nil, audio: Audio? = nil, document: Document? = nil, live_photo: LivePhoto? = nil, location: Location? = nil, photo: Array<PhotoSize>? = nil, sticker: Sticker? = nil, venue: Venue? = nil, video: Video? = nil) {
            self.animation = animation
            self.audio = audio
            self.document = document
            self.live_photo = live_photo
...
extension TelegramAPI {
     ...
     * - InputMediaVideo
    */
    public indirect enum InputPollMedia: Codable {
        ...
        case inputMediaLivePhoto(InputMediaLivePhoto)
        case inputMediaLocation(InputMediaLocation)
        case inputMediaPhoto(InputMediaPhoto)
        case inputMediaVenue(InputMediaVenue)
        ...
        public init(from decoder: Decoder) throws {
            ...
            else if let value = try? container.decode(InputMediaLivePhoto.self) {
                self = .inputMediaLivePhoto(value)
            }
            else if let value = try? container.decode(InputMediaLocation.self) {
                self = .inputMediaLocation(value)
            }
            else if let value = try? container.decode(InputMediaPhoto.self) {
                self = .inputMediaPhoto(value)
            }
            else if let value = try? container.decode(InputMediaVenue.self) {
                self = .inputMediaVenue(value)
            }
            else if let value = try? container.decode(InputMediaVideo.self) {
                self = .inputMediaVideo(value)
            }else {
                throw DecodingError.typeMismatch(InputPollMedia.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for InputPollMedia"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                ...
                case .inputMediaDocument(let value):
                    try container.encode(value)
                case .inputMediaLivePhoto(let value):
                    try container.encode(value)
                case .inputMediaLocation(let value):
                    try container.encode(value)
                case .inputMediaPhoto(let value):
                    try container.encode(value)
                case .inputMediaVenue(let value):
                    try container.encode(value)
...
extension TelegramAPI {
     ...
     * - InputMediaVideo
    */
    public indirect enum InputPollOptionMedia: Codable {
        case inputMediaAnimation(InputMediaAnimation)
        case inputMediaLivePhoto(InputMediaLivePhoto)
        case inputMediaLocation(InputMediaLocation)
        case inputMediaPhoto(InputMediaPhoto)
        case inputMediaSticker(InputMediaSticker)
        case inputMediaVenue(InputMediaVenue)
        case inputMediaVideo(InputMediaVideo)
        ...
        public init(from decoder: Decoder) throws {
            ...
            if let value = try? container.decode(InputMediaAnimation.self) {
            ...
            else if let value = try? container.decode(InputMediaSticker.self) {
                ...
                throw DecodingError.typeMismatch(InputPollOptionMedia.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for InputPollOptionMedia"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                ...
                case .inputMediaPhoto(let value):
                    try container.encode(value)
                case .inputMediaSticker(let value):
                    try container.encode(value)
                case .inputMediaVenue(let value):
                    try container.encode(value)
                case .inputMediaVideo(let value):
...
extension TelegramAPI {
    ...
    */
    public class PollOption: Codable {
        ...
        public let addition_date: Int?

        public init(persistent_id: String, text: String, text_entities: Array<MessageEntity>? = nil, media: PollMedia? = nil, voter_count: Int, added_by_user: User? = nil, added_by_chat: Chat? = nil, addition_date: Int? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class InputPollOption: Codable {
        ...
        public init(text: String, text_parse_mode: String? = nil, text_entities: Array<MessageEntity>? = nil, media: InputPollOptionMedia? = nil) {
            self.text = text
...
extension TelegramAPI {
    ...
    */
    public class PollAnswer: Codable {
        ...
        public let option_persistent_ids: Array<String>

        public init(poll_id: String, voter_chat: Chat? = nil, user: User? = nil, option_ids: Array<Int>, option_persistent_ids: Array<String>) {
...
extension TelegramAPI {
    ...
    */
    public class Poll: Codable {
        ...
        public let explanation_media: PollMedia?
        ...
        public let description_entities: Array<MessageEntity>?
        /** PollMedia | Optional. Media added to the poll description; for polls inside the Message object only */
        public let media: PollMedia?

        public init(id: String, question: String, question_entities: Array<MessageEntity>? = nil, options: Array<PollOption>, total_voter_count: Int, is_closed: Bool, is_anonymous: Bool, type: String, allows_multiple_answers: Bool, allows_revoting: Bool, members_only: Bool, country_codes: Array<String>? = nil, correct_option_ids: Array<Int>? = nil, explanation: String? = nil, explanation_entities: Array<MessageEntity>? = nil, explanation_media: PollMedia? = nil, open_period: Int? = nil, close_date: Int? = nil, description: String? = nil, description_entities: Array<MessageEntity>? = nil, media: PollMedia? = nil) {
            self.id = id
...
extension TelegramAPI {
    ...
    */
    public class ChecklistTask: Codable {
        ...
        public let completed_by_user: User?
        /** Chat | Optional. Chat that completed the task; omitted if the task wasn't completed by a chat */
        public let completed_by_chat: Chat?
        /** Integer | Optional. Point in time (Unix timestamp) when the task was completed; 0 if the task wasn't completed */
        public let completion_date: Int?

        public init(id: Int, text: String, text_entities: Array<MessageEntity>? = nil, completed_by_user: User? = nil, completed_by_chat: Chat? = nil, completion_date: Int? = nil) {
            self.id = id
            self.text = text
            self.text_entities = text_entities
...
extension TelegramAPI {
    ...
    */
    public class Checklist: Codable {
        ...
        public let title_entities: Array<MessageEntity>?
        /** Array of ChecklistTask | List of tasks in the checklist */
        public let tasks: Array<ChecklistTask>
        /** Boolean | Optional. True, if users other than the creator of the list can add tasks to the list */
        public let others_can_add_tasks: Bool?
        /** Boolean | Optional. True, if users other than the creator of the list can mark tasks as done or not done */
        public let others_can_mark_tasks_as_done: Bool?

        public init(title: String, title_entities: Array<MessageEntity>? = nil, tasks: Array<ChecklistTask>, others_can_add_tasks: Bool? = nil, others_can_mark_tasks_as_done: Bool? = nil) {
            self.title = title
...
extension TelegramAPI {
    ...
    */
    public class InputChecklistTask: Codable {
        ...
        public init(id: Int, text: String, parse_mode: String? = nil, text_entities: Array<MessageEntity>? = nil) {
            self.id = id
            self.text = text
...
extension TelegramAPI {
    ...
    */
    public class InputChecklist: Codable {
        ...
        public let tasks: Array<InputChecklistTask>
        ...
        public init(title: String, parse_mode: String? = nil, title_entities: Array<MessageEntity>? = nil, tasks: Array<InputChecklistTask>, others_can_add_tasks: Bool? = nil, others_can_mark_tasks_as_done: Bool? = nil) {
            self.title = title
            self.parse_mode = parse_mode
            self.title_entities = title_entities
            self.tasks = tasks
...
extension TelegramAPI {
    ...
    */
    public class ChecklistTasksDone: Codable {
        ...
        public let checklist_message: Message?
        /** Array of Integer | Optional. Identifiers of the tasks that were marked as done */
        public let marked_as_done_task_ids: Array<Int>?
        /** Array of Integer | Optional. Identifiers of the tasks that were marked as not done */
        public let marked_as_not_done_task_ids: Array<Int>?

        public init(checklist_message: Message? = nil, marked_as_done_task_ids: Array<Int>? = nil, marked_as_not_done_task_ids: Array<Int>? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class ChecklistTasksAdded: Codable {
        ...
        public init(checklist_message: Message? = nil, tasks: Array<ChecklistTask>) {
            self.checklist_message = checklist_message
            self.tasks = tasks
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class PollOptionAdded: Codable {
        ...
        public let poll_message: MaybeInaccessibleMessage?
        /** String | Unique identifier of the added option */
        public let option_persistent_id: String
        /** String | Option text */
        public let option_text: String
        /** Array of MessageEntity | Optional. Special entities that appear in the option_text */
        public let option_text_entities: Array<MessageEntity>?

        public init(poll_message: MaybeInaccessibleMessage? = nil, option_persistent_id: String, option_text: String, option_text_entities: Array<MessageEntity>? = nil) {
            self.poll_message = poll_message
            self.option_persistent_id = option_persistent_id
            self.option_text = option_text
            self.option_text_entities = option_text_entities
        }
    }
}
...
extension TelegramAPI {
    ...
    */
    public class PollOptionDeleted: Codable {
...
extension TelegramAPI {
    ...
    */
    public class ForumTopicCreated: Codable {
        ...
        public let is_name_implicit: Bool?

        public init(name: String, icon_color: Int, icon_custom_emoji_id: String? = nil, is_name_implicit: Bool? = nil) {
            self.name = name
...
extension TelegramAPI {
    ...
    */
    public class ForumTopicClosed: Codable {
...
extension TelegramAPI {
    ...
    */
    public class ForumTopicReopened: Codable {
...
extension TelegramAPI {
    ...
    */
    public class GeneralForumTopicHidden: Codable {
...
extension TelegramAPI {
    ...
    */
    public class GeneralForumTopicUnhidden: Codable {
...
extension TelegramAPI {
    ...
    */
    public class VideoChatStarted: Codable {
...
extension TelegramAPI {
    ...
    */
    public class PaidMessagePriceChanged: Codable {
        ...
        public init(paid_message_star_count: Int) {
            self.paid_message_star_count = paid_message_star_count
        }
    }
}
...
extension TelegramAPI {
    ...
    */
    public class DirectMessagePriceChanged: Codable {
        /** Boolean | True, if direct messages are enabled for the channel chat; false otherwise */
        public let are_direct_messages_enabled: Bool
        ...
        public let direct_message_star_count: Int?

        public init(are_direct_messages_enabled: Bool, direct_message_star_count: Int? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostApproved: Codable {
        ...
        public init(suggested_post_message: Message? = nil, price: SuggestedPostPrice? = nil, send_date: Int) {
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostApprovalFailed: Codable {
        ...
        public init(suggested_post_message: Message? = nil, price: SuggestedPostPrice) {
            self.suggested_post_message = suggested_post_message
            self.price = price
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostDeclined: Codable {
        /** Message | Optional. Message containing the suggested post. Note that the Message object in this field will not contain the reply_to_message field even if it itself is a reply. */
        public let suggested_post_message: Message?
        /** String | Optional. Comment with which the post was declined */
        public let comment: String?

        public init(suggested_post_message: Message? = nil, comment: String? = nil) {
            self.suggested_post_message = suggested_post_message
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostPaid: Codable {
        ...
        public init(suggested_post_message: Message? = nil, currency: String, amount: Int? = nil, star_amount: StarAmount? = nil) {
            self.suggested_post_message = suggested_post_message
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostRefunded: Codable {
        /** Message | Optional. Message containing the suggested post. Note that the Message object in this field will not contain the reply_to_message field even if it itself is a reply. */
        public let suggested_post_message: Message?
        ...
        public init(suggested_post_message: Message? = nil, reason: String) {
            self.suggested_post_message = suggested_post_message
            self.reason = reason
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class GiveawayCreated: Codable {
...
extension TelegramAPI {
    ...
    */
    public class GiveawayCompleted: Codable {
        ...
        public let giveaway_message: Message?
        ...
        public init(winner_count: Int, unclaimed_prize_count: Int? = nil, giveaway_message: Message? = nil, is_star_giveaway: Bool? = nil) {
            self.winner_count = winner_count
            self.unclaimed_prize_count = unclaimed_prize_count
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostInfo: Codable {
        ...
        public init(state: String, price: SuggestedPostPrice? = nil, send_date: Int? = nil) {
            self.state = state
            self.price = price
            self.send_date = send_date
        }
...
extension TelegramAPI {
    ...
    */
    public class SuggestedPostParameters: Codable {
        ...
        public init(price: SuggestedPostPrice? = nil, send_date: Int? = nil) {
            self.price = price
            self.send_date = send_date
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class UserProfileAudios: Codable {
        /** Integer | Total number of profile audios for the target user */
        public let total_count: Int
        /** Array of Audio | Requested profile audios */
        public let audios: Array<Audio>

        public init(total_count: Int, audios: Array<Audio>) {
            self.total_count = total_count
            self.audios = audios
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class KeyboardButton: Codable {
        ...
        public let request_managed_bot: KeyboardButtonRequestManagedBot?
        ...
        public init(text: String, icon_custom_emoji_id: String? = nil, style: String? = nil, request_users: KeyboardButtonRequestUsers? = nil, request_chat: KeyboardButtonRequestChat? = nil, request_managed_bot: KeyboardButtonRequestManagedBot? = nil, request_contact: Bool? = nil, request_location: Bool? = nil, request_poll: KeyboardButtonPollType? = nil, web_app: WebAppInfo? = nil) {
            self.text = text
            self.icon_custom_emoji_id = icon_custom_emoji_id
            self.style = style
...
extension TelegramAPI {
    ...
    */
    public class KeyboardButtonRequestManagedBot: Codable {
        ...
        public let suggested_username: String?

        public init(request_id: Int, suggested_name: String? = nil, suggested_username: String? = nil) {
            self.request_id = request_id
...
extension TelegramAPI {
    ...
    */
    public class InlineKeyboardButton: Codable {
        ...
        public init(text: String, icon_custom_emoji_id: String? = nil, style: String? = nil, url: String? = nil, callback_data: String? = nil, web_app: WebAppInfo? = nil, login_url: LoginUrl? = nil, switch_inline_query: String? = nil, switch_inline_query_current_chat: String? = nil, switch_inline_query_chosen_chat: SwitchInlineQueryChosenChat? = nil, copy_text: CopyTextButton? = nil, callback_game: CallbackGame? = nil, pay: Bool? = nil) {
            self.text = text
            self.icon_custom_emoji_id = icon_custom_emoji_id
            self.style = style
            self.url = url
...
extension TelegramAPI {
    ...
    */
    public class CopyTextButton: Codable {
...
extension TelegramAPI {
    ...
    */
    public class ChatAdministratorRights: Codable {
        ...
        public let can_manage_direct_messages: Bool?
        /** Boolean | Optional. True, if the administrator can edit the tags of regular members; for groups and supergroups only. If omitted defaults to the value of can_pin_messages. */
        public let can_manage_tags: Bool?

        public init(is_anonymous: Bool, can_manage_chat: Bool, can_delete_messages: Bool, can_manage_video_chats: Bool, can_restrict_members: Bool, can_promote_members: Bool, can_change_info: Bool, can_invite_users: Bool, can_post_stories: Bool, can_edit_stories: Bool, can_delete_stories: Bool, can_post_messages: Bool? = nil, can_edit_messages: Bool? = nil, can_pin_messages: Bool? = nil, can_manage_topics: Bool? = nil, can_manage_direct_messages: Bool? = nil, can_manage_tags: Bool? = nil) {
            self.is_anonymous = is_anonymous
...
extension TelegramAPI {
    ...
    */
    public class ChatMemberAdministrator: Codable {
        ...
        public init(status: String, user: User, can_be_edited: Bool, is_anonymous: Bool, can_manage_chat: Bool, can_delete_messages: Bool, can_manage_video_chats: Bool, can_restrict_members: Bool, can_promote_members: Bool, can_change_info: Bool, can_invite_users: Bool, can_post_stories: Bool, can_edit_stories: Bool, can_delete_stories: Bool, can_post_messages: Bool? = nil, can_edit_messages: Bool? = nil, can_pin_messages: Bool? = nil, can_manage_topics: Bool? = nil, can_manage_direct_messages: Bool? = nil, can_manage_tags: Bool? = nil, custom_title: String? = nil) {
            self.status = status
            self.user = user
...
extension TelegramAPI {
    ...
    */
    public class ChatMemberMember: Codable {
        ...
        public init(status: String, tag: String? = nil, user: User, until_date: Int? = nil) {
            self.status = status
            self.tag = tag
            self.user = user
...
extension TelegramAPI {
    ...
    */
    public class UserRating: Codable {
        ...
        public let current_level_rating: Int
        /** Integer | Optional. The rating value required to get to the next level; omitted if the maximum level was reached */
        public let next_level_rating: Int?

        public init(level: Int, rating: Int, current_level_rating: Int, next_level_rating: Int? = nil) {
            self.level = level
            self.rating = rating
...
extension TelegramAPI {
    ...
    */
    public class LocationAddress: Codable {
        ...
        public init(country_code: String, state: String? = nil, city: String? = nil, street: String? = nil) {
...
extension TelegramAPI {
    ...
    */
    public indirect enum StoryAreaType: Codable {
        ...
        case storyAreaTypeUniqueGift(StoryAreaTypeUniqueGift)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(StoryAreaTypeLocation.self) {
                self = .storyAreaTypeLocation(value)
            }
            else if let value = try? container.decode(StoryAreaTypeSuggestedReaction.self) {
                self = .storyAreaTypeSuggestedReaction(value)
            }
            else if let value = try? container.decode(StoryAreaTypeLink.self) {
                self = .storyAreaTypeLink(value)
            }
            else if let value = try? container.decode(StoryAreaTypeWeather.self) {
                self = .storyAreaTypeWeather(value)
            }
            else if let value = try? container.decode(StoryAreaTypeUniqueGift.self) {
                self = .storyAreaTypeUniqueGift(value)
            }else {
                throw DecodingError.typeMismatch(StoryAreaType.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for StoryAreaType"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                ...
                case .storyAreaTypeWeather(let value):
                    try container.encode(value)
                case .storyAreaTypeUniqueGift(let value):
                    try container.encode(value)
            }
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class StoryAreaTypeLocation: Codable {
        ...
        public init(type: String, latitude: Float, longitude: Float, address: LocationAddress? = nil) {
            self.type = type
            self.latitude = latitude
            self.longitude = longitude
            self.address = address
...
extension TelegramAPI {
    ...
    */
    public class StoryAreaTypeSuggestedReaction: Codable {
        /** String | Type of the area, always "suggested_reaction" */
        public let type: String
        /** ReactionType | Type of the reaction */
        public let reaction_type: ReactionType
        /** Boolean | Optional. Pass True if the reaction area has a dark background */
        public let is_dark: Bool?
        /** Boolean | Optional. Pass True if reaction area corner is flipped */
        public let is_flipped: Bool?

        public init(type: String, reaction_type: ReactionType, is_dark: Bool? = nil, is_flipped: Bool? = nil) {
            self.type = type
...
extension TelegramAPI {
    ...
    */
    public class StoryAreaTypeLink: Codable {
...
extension TelegramAPI {
    ...
    */
    public class StoryAreaTypeWeather: Codable {
        ...
        public let background_color: Int

        public init(type: String, temperature: Float, emoji: String, background_color: Int) {
            self.type = type
...
extension TelegramAPI {
    ...
    */
    public class StoryAreaTypeUniqueGift: Codable {
...
extension TelegramAPI {
    ...
    */
    public class StoryArea: Codable {
        ...
        public init(position: StoryAreaPosition, type: StoryAreaType) {
            self.position = position
            self.type = type
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class ForumTopic: Codable {
        ...
        public init(message_thread_id: Int, name: String, icon_color: Int, icon_custom_emoji_id: String? = nil, is_name_implicit: Bool? = nil) {
            self.message_thread_id = message_thread_id
            self.name = name
            self.icon_color = icon_color
            self.icon_custom_emoji_id = icon_custom_emoji_id
...
extension TelegramAPI {
    ...
    */
    public class GiftBackground: Codable {
        /** Integer | Center color of the background in RGB format */
        public let center_color: Int
        /** Integer | Edge color of the background in RGB format */
        public let edge_color: Int
        /** Integer | Text color of the background in RGB format */
        public let text_color: Int

        public init(center_color: Int, edge_color: Int, text_color: Int) {
...
extension TelegramAPI {
    ...
    */
    public class Gift: Codable {
        ...
        public let unique_gift_variant_count: Int?
        /** Chat | Optional. Information about the chat that published the gift */
        public let publisher_chat: Chat?

        public init(id: String, sticker: Sticker, star_count: Int, upgrade_star_count: Int? = nil, is_premium: Bool? = nil, has_colors: Bool? = nil, total_count: Int? = nil, remaining_count: Int? = nil, personal_total_count: Int? = nil, personal_remaining_count: Int? = nil, background: GiftBackground? = nil, unique_gift_variant_count: Int? = nil, publisher_chat: Chat? = nil) {
            self.id = id
            self.sticker = sticker
            self.star_count = star_count
...
extension TelegramAPI {
    ...
    */
    public class UniqueGiftModel: Codable {
...
extension TelegramAPI {
    ...
    */
    public class UniqueGiftSymbol: Codable {
        ...
        public init(name: String, sticker: Sticker, rarity_per_mille: Int) {
            self.name = name
            self.sticker = sticker
            self.rarity_per_mille = rarity_per_mille
        }
...
extension TelegramAPI {
    ...
    */
    public class UniqueGiftBackdropColors: Codable {
        ...
        public let symbol_color: Int
        /** Integer | The color for the text on the backdrop in RGB format */
        public let text_color: Int

        public init(center_color: Int, edge_color: Int, symbol_color: Int, text_color: Int) {
            self.center_color = center_color
            self.edge_color = edge_color
...
extension TelegramAPI {
    ...
    */
    public class UniqueGiftColors: Codable {
        /** String | Custom emoji identifier of the unique gift's model */
        public let model_custom_emoji_id: String
        /** String | Custom emoji identifier of the unique gift's symbol */
        public let symbol_custom_emoji_id: String
        /** Integer | Main color used in light themes; RGB format */
        public let light_theme_main_color: Int
        /** Array of Integer | List of 1-3 additional colors used in light themes; RGB format */
        public let light_theme_other_colors: Array<Int>
        /** Integer | Main color used in dark themes; RGB format */
        public let dark_theme_main_color: Int
        /** Array of Integer | List of 1-3 additional colors used in dark themes; RGB format */
        public let dark_theme_other_colors: Array<Int>

        public init(model_custom_emoji_id: String, symbol_custom_emoji_id: String, light_theme_main_color: Int, light_theme_other_colors: Array<Int>, dark_theme_main_color: Int, dark_theme_other_colors: Array<Int>) {
...
extension TelegramAPI {
    ...
    */
    public class UniqueGift: Codable {
        ...
        public let model: UniqueGiftModel
        /** UniqueGiftSymbol | Symbol of the gift */
        public let symbol: UniqueGiftSymbol
        /** UniqueGiftBackdrop | Backdrop of the gift */
        public let backdrop: UniqueGiftBackdrop
        ...
        public let colors: UniqueGiftColors?
        /** Chat | Optional. Information about the chat that published the gift */
        public let publisher_chat: Chat?

        public init(gift_id: String, base_name: String, name: String, number: Int, model: UniqueGiftModel, symbol: UniqueGiftSymbol, backdrop: UniqueGiftBackdrop, is_premium: Bool? = nil, is_burned: Bool? = nil, is_from_blockchain: Bool? = nil, colors: UniqueGiftColors? = nil, publisher_chat: Chat? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class GiftInfo: Codable {
        ...
        public let convert_star_count: Int?
        ...
        public let can_be_upgraded: Bool?
...
extension TelegramAPI {
     ...
     * - OwnedGiftUnique
    */
    public indirect enum OwnedGift: Codable {
        case ownedGiftRegular(OwnedGiftRegular)
        case ownedGiftUnique(OwnedGiftUnique)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(OwnedGiftRegular.self) {
                self = .ownedGiftRegular(value)
            }
            else if let value = try? container.decode(OwnedGiftUnique.self) {
                self = .ownedGiftUnique(value)
            }else {
                throw DecodingError.typeMismatch(OwnedGift.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for OwnedGift"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.singleValueContainer()
            switch self {
                case .ownedGiftRegular(let value):
                    try container.encode(value)
                case .ownedGiftUnique(let value):
                    try container.encode(value)
            }
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class OwnedGiftRegular: Codable {
...
extension TelegramAPI {
    ...
    */
    public class OwnedGiftUnique: Codable {
...
extension TelegramAPI {
    ...
    */
    public class OwnedGifts: Codable {
...
extension TelegramAPI {
    ...
    */
    public class StarAmount: Codable {
        ...
        public init(amount: Int, nanostar_amount: Int? = nil) {
            self.amount = amount
...
extension TelegramAPI {
    ...
    */
    public class ChatOwnerChanged: Codable {
        /** User | The new owner of the chat */
        public let new_owner: User

        public init(new_owner: User) {
            self.new_owner = new_owner
        }
    }
}
...
extension TelegramAPI {
    ...
    */
    public class BusinessBotRights: Codable {
        ...
        public let can_transfer_stars: Bool?
...
extension TelegramAPI {
    ...
    */
    public class BusinessConnection: Codable {
        ...
        public init(id: String, user: User, user_chat_id: Int, date: Int, rights: BusinessBotRights? = nil, is_enabled: Bool) {
            self.id = id
            self.user = user
            self.user_chat_id = user_chat_id
            self.date = date
...
extension TelegramAPI {
    ...
    */
    public class SentGuestMessage: Codable {
        /** String | Identifier of the sent inline message */
        public let inline_message_id: String

        public init(inline_message_id: String) {
            self.inline_message_id = inline_message_id
        }
    }
}
...
extension TelegramAPI {
    ...
    */
    public class PreparedKeyboardButton: Codable {
...
extension TelegramAPI {
    ...
    */
    public class InputMediaAnimation: Codable {
        ...
        public init(type: String, media: String, thumbnail: String? = nil, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, show_caption_above_media: Bool? = nil, width: Int? = nil, height: Int? = nil, duration: Int? = nil, has_spoiler: Bool? = nil) {
            self.type = type
            self.media = media
            self.thumbnail = thumbnail
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class InputMediaAudio: Codable {
        ...
        public init(type: String, media: String, thumbnail: String? = nil, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, duration: Int? = nil, performer: String? = nil, title: String? = nil) {
            self.type = type
            self.media = media
            self.thumbnail = thumbnail
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class InputMediaDocument: Codable {
        ...
        public init(type: String, media: String, thumbnail: String? = nil, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, disable_content_type_detection: Bool? = nil) {
            self.type = type
            self.media = media
            self.thumbnail = thumbnail
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class InputMediaLivePhoto: Codable {
        ...
        public init(type: String, media: String, photo: String, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, show_caption_above_media: Bool? = nil, has_spoiler: Bool? = nil) {
            self.type = type
            self.media = media
            self.photo = photo
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class InputMediaLocation: Codable {
        ...
        public init(type: String, latitude: Float, longitude: Float, horizontal_accuracy: Float? = nil) {
            self.type = type
            self.latitude = latitude
            self.longitude = longitude
            self.horizontal_accuracy = horizontal_accuracy
...
extension TelegramAPI {
    ...
    */
    public class InputMediaSticker: Codable {
        ...
        public init(type: String, media: String, emoji: String? = nil) {
            self.type = type
            self.media = media
            self.emoji = emoji
        }
...
extension TelegramAPI {
    ...
    */
    public class InputMediaVenue: Codable {
        ...
        public init(type: String, latitude: Float, longitude: Float, title: String, address: String, foursquare_id: String? = nil, foursquare_type: String? = nil, google_place_id: String? = nil, google_place_type: String? = nil) {
            self.type = type
            self.latitude = latitude
            self.longitude = longitude
            self.title = title
...
extension TelegramAPI {
    ...
    */
    public class InputMediaVideo: Codable {
        ...
        public init(type: String, media: String, thumbnail: String? = nil, cover: String? = nil, start_timestamp: Int? = nil, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, show_caption_above_media: Bool? = nil, width: Int? = nil, height: Int? = nil, duration: Int? = nil, supports_streaming: Bool? = nil, has_spoiler: Bool? = nil) {
            self.type = type
            self.media = media
            self.thumbnail = thumbnail
            self.cover = cover
...
extension TelegramAPI {
    ...
    */
    public indirect enum InputPaidMedia: Codable {
        case inputPaidMediaLivePhoto(InputPaidMediaLivePhoto)
        case inputPaidMediaPhoto(InputPaidMediaPhoto)
        case inputPaidMediaVideo(InputPaidMediaVideo)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(InputPaidMediaLivePhoto.self) {
                self = .inputPaidMediaLivePhoto(value)
            }
            else if let value = try? container.decode(InputPaidMediaPhoto.self) {
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.singleValueContainer()
            switch self {
                case .inputPaidMediaLivePhoto(let value):
                    try container.encode(value)
...
extension TelegramAPI {
    ...
    */
    public class InputPaidMediaLivePhoto: Codable {
        ...
        public init(type: String, media: String, photo: String) {
            self.type = type
            self.media = media
            self.photo = photo
        }
...
extension TelegramAPI {
    ...
    */
    public class InputPaidMediaVideo: Codable {
        ...
        public init(type: String, media: String, thumbnail: String? = nil, cover: String? = nil, start_timestamp: Int? = nil, width: Int? = nil, height: Int? = nil, duration: Int? = nil, supports_streaming: Bool? = nil) {
            self.type = type
            self.media = media
            self.thumbnail = thumbnail
            self.cover = cover
...
extension TelegramAPI {
    ...
    */
    public indirect enum InputProfilePhoto: Codable {
        case inputProfilePhotoStatic(InputProfilePhotoStatic)
        case inputProfilePhotoAnimated(InputProfilePhotoAnimated)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(InputProfilePhotoStatic.self) {
                self = .inputProfilePhotoStatic(value)
            }
            else if let value = try? container.decode(InputProfilePhotoAnimated.self) {
                self = .inputProfilePhotoAnimated(value)
            }else {
                throw DecodingError.typeMismatch(InputProfilePhoto.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for InputProfilePhoto"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.singleValueContainer()
            switch self {
                case .inputProfilePhotoStatic(let value):
                    try container.encode(value)
                case .inputProfilePhotoAnimated(let value):
                    try container.encode(value)
            }
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class InputProfilePhotoStatic: Codable {
        ...
        public init(type: String, photo: String) {
            self.type = type
            self.photo = photo
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class InputProfilePhotoAnimated: Codable {
        ...
        public let main_frame_timestamp: Float?

        public init(type: String, animation: String, main_frame_timestamp: Float? = nil) {
            self.type = type
            self.animation = animation
...
extension TelegramAPI {
    ...
    */
    public indirect enum InputStoryContent: Codable {
        case inputStoryContentPhoto(InputStoryContentPhoto)
        case inputStoryContentVideo(InputStoryContentVideo)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(InputStoryContentPhoto.self) {
                self = .inputStoryContentPhoto(value)
            }
            else if let value = try? container.decode(InputStoryContentVideo.self) {
                self = .inputStoryContentVideo(value)
            }else {
                throw DecodingError.typeMismatch(InputStoryContent.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for InputStoryContent"))
            }
        }
...
extension TelegramAPI {
    ...
    */
    public class InputStoryContentPhoto: Codable {
...
extension TelegramAPI {
    ...
    */
    public class InputStoryContentVideo: Codable {
        ...
        public let cover_frame_timestamp: Float?
        /** Boolean | Optional. Pass True if the video has no sound */
        public let is_animation: Bool?

        public init(type: String, video: String, duration: Float? = nil, cover_frame_timestamp: Float? = nil, is_animation: Bool? = nil) {
            self.type = type
            self.video = video
            self.duration = duration
...
extension TelegramAPI {
    ...
    */
    public class InputSticker: Codable {
        ...
        public init(sticker: String, format: String, emoji_list: Array<String>, mask_position: MaskPosition? = nil, keywords: Array<String>? = nil) {
            self.sticker = sticker
            self.format = format
...
extension TelegramAPI {
    ...
    */
    public class PaidMediaPurchased: Codable {
...
extension TelegramAPI {
    ...
    */
    public class AffiliateInfo: Codable {
...
extension TelegramAPI {
    ...
    */
    public indirect enum TransactionPartner: Codable {
        ...
        case transactionPartnerChat(TransactionPartnerChat)
        ...
        public init(from decoder: Decoder) throws {
            ...
            else if let value = try? container.decode(TransactionPartnerChat.self) {
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                case .transactionPartnerUser(let value):
                    try container.encode(value)
                case .transactionPartnerChat(let value):
                    try container.encode(value)
...
extension TelegramAPI {
    ...
    */
    public class TransactionPartnerUser: Codable {
        ...
        public let premium_subscription_duration: Int?

        public init(type: String, transaction_type: String, user: User, affiliate: AffiliateInfo? = nil, invoice_payload: String? = nil, subscription_period: Int? = nil, paid_media: Array<PaidMedia>? = nil, paid_media_payload: String? = nil, gift: Gift? = nil, premium_subscription_duration: Int? = nil) {
            self.type = type
...
extension TelegramAPI {
    ...
    */
    public class TransactionPartnerChat: Codable {
        ...
        public init(type: String, chat: Chat, gift: Gift? = nil) {
            self.type = type
            self.chat = chat
            self.gift = gift
        }
...
extension TelegramAPI {
    ...
    */
    public class TransactionPartnerAffiliateProgram: Codable {
...
extension TelegramAPI {
    ...
    */
    public class TransactionPartnerTelegramApi: Codable {
...
extension TelegramAPI {
    public class ResponseSuccess<T: Codable>: Codable {
        public let ok: Bool
        public let result: T
    }
...
extension TelegramAPI {
    ...
    public struct SendMessageParams: Codable {
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, text: String, parse_mode: ParseMode? = nil, entities: Array<MessageEntity>? = nil, link_preview_options: LinkPreviewOptions? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, suggested_post_parameters: SuggestedPostParameters? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: Either4<InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply>? = nil) {
            ...
            self.suggested_post_parameters = suggested_post_parameters
...
extension TelegramAPI {
    ...
    public struct ForwardMessageParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, from_chat_id: Either2<Int, String>, video_start_timestamp: Int? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, message_effect_id: String? = nil, suggested_post_parameters: SuggestedPostParameters? = nil, message_id: Int) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public struct ForwardMessagesParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, from_chat_id: Either2<Int, String>, message_ids: Array<Int>, disable_notification: Bool? = nil, protect_content: Bool? = nil) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
            self.from_chat_id = from_chat_id
...
extension TelegramAPI {
    ...
    public struct CopyMessagesParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, from_chat_id: Either2<Int, String>, message_ids: Array<Int>, disable_notification: Bool? = nil, protect_content: Bool? = nil, remove_caption: Bool? = nil) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
            self.from_chat_id = from_chat_id
...
extension TelegramAPI {
    ...
    public struct SendLivePhotoParams: Codable {
        /** String | Unique identifier of the business connection on behalf of which the message will be sent */
        public let business_connection_id: String?
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, live_photo: Either2<InputFile, String>, photo: Either2<InputFile, String>, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, show_caption_above_media: Bool? = nil, has_spoiler: Bool? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, suggested_post_parameters: SuggestedPostParameters? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: Either4<InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply>? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public typealias SendLivePhotoResponse = ResponseSuccess<Message>
...
extension TelegramAPI {
    ...
    public struct SendVideoParams: Codable {
        ...
        public let cover: Either2<InputFile, String>?
...
extension TelegramAPI {
    ...
    public struct SendMediaGroupParams: Codable {
        ...
        public let media: Either5<Array<InputMediaAudio>, Array<InputMediaDocument>, Array<InputMediaLivePhoto>, Array<InputMediaPhoto>, Array<InputMediaVideo>>
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, media: Either5<Array<InputMediaAudio>, Array<InputMediaDocument>, Array<InputMediaLivePhoto>, Array<InputMediaPhoto>, Array<InputMediaVideo>>, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public struct SendPollParams: Codable {
        ...
        public let shuffle_options: Bool?
        ...
        public let allow_adding_options: Bool?
        ...
        public let description_parse_mode: String?
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, question: String, question_parse_mode: String? = nil, question_entities: Array<MessageEntity>? = nil, options: Array<InputPollOption>, is_anonymous: Bool? = nil, type: String? = nil, allows_multiple_answers: Bool? = nil, allows_revoting: Bool? = nil, shuffle_options: Bool? = nil, allow_adding_options: Bool? = nil, hide_results_until_closes: Bool? = nil, members_only: Bool? = nil, country_codes: Array<String>? = nil, correct_option_ids: Array<Int>? = nil, explanation: String? = nil, explanation_parse_mode: String? = nil, explanation_entities: Array<MessageEntity>? = nil, explanation_media: InputPollMedia? = nil, open_period: Int? = nil, close_date: Int? = nil, is_closed: Bool? = nil, description: String? = nil, description_parse_mode: String? = nil, description_entities: Array<MessageEntity>? = nil, media: InputPollMedia? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: Either4<InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply>? = nil) {
            ...
            self.is_closed = is_closed
            self.description = description
            self.description_parse_mode = description_parse_mode
            self.description_entities = description_entities
            self.media = media
            self.disable_notification = disable_notification
            self.protect_content = protect_content
...
extension TelegramAPI {
    ...
    public struct SendChecklistParams: Codable {
        /** String | Unique identifier of the business connection on behalf of which the message will be sent */
        public let business_connection_id: String
        ...
        public init(business_connection_id: String, chat_id: Either2<Int, String>, checklist: InputChecklist, disable_notification: Bool? = nil, protect_content: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.checklist = checklist
            self.disable_notification = disable_notification
...
extension TelegramAPI {
    ...
    public typealias SendChecklistResponse = ResponseSuccess<Message>
...
extension TelegramAPI {
    ...
    public struct SendMessageDraftParams: Codable {
        ...
        public init(chat_id: Int, message_thread_id: Int? = nil, draft_id: Int, text: String? = nil, parse_mode: String? = nil, entities: Array<MessageEntity>? = nil) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
...
extension TelegramAPI {
    ...
    public typealias SendMessageDraftResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct GetUserProfileAudiosParams: Codable {
        /** Integer | Unique identifier of the target user */
        public let user_id: Int
...
extension TelegramAPI {
    ...
    public typealias GetUserProfileAudiosResponse = ResponseSuccess<UserProfileAudios>
...
extension TelegramAPI {
    ...
    public struct PromoteChatMemberParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, user_id: Int, is_anonymous: Bool? = nil, can_manage_chat: Bool? = nil, can_delete_messages: Bool? = nil, can_manage_video_chats: Bool? = nil, can_restrict_members: Bool? = nil, can_promote_members: Bool? = nil, can_change_info: Bool? = nil, can_invite_users: Bool? = nil, can_post_stories: Bool? = nil, can_edit_stories: Bool? = nil, can_delete_stories: Bool? = nil, can_post_messages: Bool? = nil, can_edit_messages: Bool? = nil, can_pin_messages: Bool? = nil, can_manage_topics: Bool? = nil, can_manage_direct_messages: Bool? = nil, can_manage_tags: Bool? = nil) {
            self.chat_id = chat_id
            self.user_id = user_id
            self.is_anonymous = is_anonymous
            self.can_manage_chat = can_manage_chat
...
extension TelegramAPI {
    ...
    public struct SetChatMemberTagParams: Codable {
        /** Integer or String | Unique identifier for the target chat or username of the target supergroup in the format @username */
        public let chat_id: Either2<Int, String>
        /** Integer | Unique identifier of the target user */
        public let user_id: Int
        ...
        public init(chat_id: Either2<Int, String>, user_id: Int, tag: String? = nil) {
            self.chat_id = chat_id
            self.user_id = user_id
            self.tag = tag
        }
...
extension TelegramAPI {
    ...
    public typealias SetChatMemberTagResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct GetChatAdministratorsParams: Codable {
        ...
        public let return_bots: Bool?
        
        public init(chat_id: Either2<Int, String>, return_bots: Bool? = nil) {
            self.chat_id = chat_id
            self.return_bots = return_bots
        }
    }
}
...
extension TelegramAPI {
    ...
    public typealias GetUserPersonalChatMessagesResponse = ResponseSuccess<Array<Message>>
...
extension TelegramAPI {
    ...
    public typealias AnswerGuestQueryResponse = ResponseSuccess<SentGuestMessage>
...
extension TelegramAPI {
    ...
    public struct GetManagedBotTokenParams: Codable {
...
extension TelegramAPI {
    ...
    public typealias GetManagedBotTokenResponse = ResponseSuccess<String>
...
extension TelegramAPI {
    ...
    public struct ReplaceManagedBotTokenParams: Codable {
...
extension TelegramAPI {
    ...
    public typealias ReplaceManagedBotTokenResponse = ResponseSuccess<String>
...
extension TelegramAPI {
    ...
    public struct GetManagedBotAccessSettingsParams: Codable {
...
extension TelegramAPI {
    ...
    public typealias GetManagedBotAccessSettingsResponse = ResponseSuccess<BotAccessSettings>
...
extension TelegramAPI {
    ...
    public struct SetManagedBotAccessSettingsParams: Codable {
        ...
        public let added_user_ids: Array<Int>?
        
        public init(user_id: Int, is_access_restricted: Bool, added_user_ids: Array<Int>? = nil) {
            self.user_id = user_id
            self.is_access_restricted = is_access_restricted
...
extension TelegramAPI {
    ...
    public typealias SetManagedBotAccessSettingsResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetMyProfilePhotoParams: Codable {
        /** InputProfilePhoto | The new profile photo to set */
        public let photo: InputProfilePhoto
        
        public init(photo: InputProfilePhoto) {
            self.photo = photo
        }
    }
}
...
extension TelegramAPI {
    ...
    public typealias SetMyProfilePhotoResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public typealias RemoveMyProfilePhotoResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SendGiftParams: Codable {
        ...
        public init(user_id: Int? = nil, chat_id: Either2<Int, String>? = nil, gift_id: String, pay_for_upgrade: Bool? = nil, text: String? = nil, text_parse_mode: String? = nil, text_entities: Array<MessageEntity>? = nil) {
            self.user_id = user_id
            self.chat_id = chat_id
            self.gift_id = gift_id
...
extension TelegramAPI {
    ...
    public struct GiftPremiumSubscriptionParams: Codable {
        ...
        public init(user_id: Int, month_count: Int, star_count: Int, text: String? = nil, text_parse_mode: String? = nil, text_entities: Array<MessageEntity>? = nil) {
            self.user_id = user_id
...
extension TelegramAPI {
    ...
    public typealias GiftPremiumSubscriptionResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct ReadBusinessMessageParams: Codable {
        ...
        public init(business_connection_id: String, chat_id: Int, message_id: Int) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_id = message_id
        }
...
extension TelegramAPI {
    ...
    public typealias ReadBusinessMessageResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public typealias DeleteBusinessMessagesResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetBusinessAccountNameParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public init(business_connection_id: String, first_name: String, last_name: String? = nil) {
            self.business_connection_id = business_connection_id
            self.first_name = first_name
            self.last_name = last_name
        }
...
extension TelegramAPI {
    ...
    public typealias SetBusinessAccountNameResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetBusinessAccountUsernameParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** String | The new value of the username for the business account; 0-32 characters */
        public let username: String?
        
        public init(business_connection_id: String, username: String? = nil) {
            self.business_connection_id = business_connection_id
            self.username = username
        }
    }
...
extension TelegramAPI {
    ...
    public typealias SetBusinessAccountUsernameResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetBusinessAccountBioParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** String | The new value of the bio for the business account; 0-140 characters */
        public let bio: String?
        
        public init(business_connection_id: String, bio: String? = nil) {
            self.business_connection_id = business_connection_id
            self.bio = bio
        }
    }
...
extension TelegramAPI {
    ...
    public typealias SetBusinessAccountBioResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetBusinessAccountProfilePhotoParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** InputProfilePhoto | The new profile photo to set */
        public let photo: InputProfilePhoto
        ...
        public init(business_connection_id: String, photo: InputProfilePhoto, is_public: Bool? = nil) {
            self.business_connection_id = business_connection_id
            self.photo = photo
...
extension TelegramAPI {
    ...
    public typealias SetBusinessAccountProfilePhotoResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct RemoveBusinessAccountProfilePhotoParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public init(business_connection_id: String, is_public: Bool? = nil) {
            self.business_connection_id = business_connection_id
            self.is_public = is_public
        }
    }
...
extension TelegramAPI {
    ...
    public typealias RemoveBusinessAccountProfilePhotoResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SetBusinessAccountGiftSettingsParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public let show_gift_button: Bool
        /** AcceptedGiftTypes | Types of gifts accepted by the business account */
        public let accepted_gift_types: AcceptedGiftTypes
        
        public init(business_connection_id: String, show_gift_button: Bool, accepted_gift_types: AcceptedGiftTypes) {
            self.business_connection_id = business_connection_id
...
extension TelegramAPI {
    ...
    public typealias SetBusinessAccountGiftSettingsResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct GetBusinessAccountStarBalanceParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
...
extension TelegramAPI {
    ...
    public typealias GetBusinessAccountStarBalanceResponse = ResponseSuccess<StarAmount>
...
extension TelegramAPI {
    ...
    public struct TransferBusinessAccountStarsParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** Integer | Number of Telegram Stars to transfer; 1-10000 */
        public let star_count: Int
        
        public init(business_connection_id: String, star_count: Int) {
            self.business_connection_id = business_connection_id
            self.star_count = star_count
        }
    }
...
extension TelegramAPI {
    ...
    public typealias TransferBusinessAccountStarsResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct GetBusinessAccountGiftsParams: Codable {
        ...
        public let exclude_from_blockchain: Bool?
        ...
        public init(business_connection_id: String, exclude_unsaved: Bool? = nil, exclude_saved: Bool? = nil, exclude_unlimited: Bool? = nil, exclude_limited_upgradable: Bool? = nil, exclude_limited_non_upgradable: Bool? = nil, exclude_unique: Bool? = nil, exclude_from_blockchain: Bool? = nil, sort_by_price: Bool? = nil, offset: String? = nil, limit: Int? = nil) {
            ...
            self.exclude_limited_upgradable = exclude_limited_upgradable
            self.exclude_limited_non_upgradable = exclude_limited_non_upgradable
            self.exclude_unique = exclude_unique
            self.exclude_from_blockchain = exclude_from_blockchain
...
extension TelegramAPI {
    ...
    public typealias GetBusinessAccountGiftsResponse = ResponseSuccess<OwnedGifts>
...
extension TelegramAPI {
    ...
    public struct GetUserGiftsParams: Codable {
...
extension TelegramAPI {
    ...
    public typealias GetUserGiftsResponse = ResponseSuccess<OwnedGifts>
...
extension TelegramAPI {
    ...
    public struct GetChatGiftsParams: Codable {
        /** Integer or String | Unique identifier for the target chat or username of the target channel in the format @username */
        public let chat_id: Either2<Int, String>
...
extension TelegramAPI {
    ...
    public typealias GetChatGiftsResponse = ResponseSuccess<OwnedGifts>
...
extension TelegramAPI {
    ...
    public struct ConvertGiftToStarsParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** String | Unique identifier of the regular gift that should be converted to Telegram Stars */
        public let owned_gift_id: String
        
        public init(business_connection_id: String, owned_gift_id: String) {
            self.business_connection_id = business_connection_id
            self.owned_gift_id = owned_gift_id
        }
    }
...
extension TelegramAPI {
    ...
    public typealias ConvertGiftToStarsResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct UpgradeGiftParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public let keep_original_details: Bool?
        ...
        public init(business_connection_id: String, owned_gift_id: String, keep_original_details: Bool? = nil, star_count: Int? = nil) {
            self.business_connection_id = business_connection_id
            self.owned_gift_id = owned_gift_id
...
extension TelegramAPI {
    ...
    public typealias UpgradeGiftResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct TransferGiftParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public let new_owner_chat_id: Int
        ...
        public init(business_connection_id: String, owned_gift_id: String, new_owner_chat_id: Int, star_count: Int? = nil) {
            self.business_connection_id = business_connection_id
            self.owned_gift_id = owned_gift_id
...
extension TelegramAPI {
    ...
    public typealias TransferGiftResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct PostStoryParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        ...
        public let areas: Array<StoryArea>?
        /** Boolean | Pass True to keep the story accessible after it expires */
        public let post_to_chat_page: Bool?
        /** Boolean | Pass True if the content of the story must be protected from forwarding and screenshotting */
        public let protect_content: Bool?
        
        public init(business_connection_id: String, content: InputStoryContent, active_period: Int, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, areas: Array<StoryArea>? = nil, post_to_chat_page: Bool? = nil, protect_content: Bool? = nil) {
            self.business_connection_id = business_connection_id
            ...
            self.caption_entities = caption_entities
            self.areas = areas
            self.post_to_chat_page = post_to_chat_page
            self.protect_content = protect_content
        }
    }
}
...
extension TelegramAPI {
    ...
    public typealias PostStoryResponse = ResponseSuccess<Story>
...
extension TelegramAPI {
    ...
    public struct RepostStoryParams: Codable {
        ...
        public init(business_connection_id: String, from_chat_id: Int, from_story_id: Int, active_period: Int, post_to_chat_page: Bool? = nil, protect_content: Bool? = nil) {
            self.business_connection_id = business_connection_id
            self.from_chat_id = from_chat_id
...
extension TelegramAPI {
    ...
    public typealias RepostStoryResponse = ResponseSuccess<Story>
...
extension TelegramAPI {
    ...
    public struct EditStoryParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** Integer | Unique identifier of the story to edit */
        public let story_id: Int
        /** InputStoryContent | Content of the story */
        public let content: InputStoryContent
        /** String | Caption of the story, 0-2048 characters after entities parsing */
        public let caption: String?
        ...
        public init(business_connection_id: String, story_id: Int, content: InputStoryContent, caption: String? = nil, parse_mode: String? = nil, caption_entities: Array<MessageEntity>? = nil, areas: Array<StoryArea>? = nil) {
            self.business_connection_id = business_connection_id
...
extension TelegramAPI {
    ...
    public typealias EditStoryResponse = ResponseSuccess<Story>
...
extension TelegramAPI {
    ...
    public struct DeleteStoryParams: Codable {
        /** String | Unique identifier of the business connection */
        public let business_connection_id: String
        /** Integer | Unique identifier of the story to delete */
        public let story_id: Int
        
        public init(business_connection_id: String, story_id: Int) {
            self.business_connection_id = business_connection_id
            self.story_id = story_id
        }
    }
...
extension TelegramAPI {
    ...
    public typealias DeleteStoryResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public typealias SavePreparedKeyboardButtonResponse = ResponseSuccess<PreparedKeyboardButton>
...
extension TelegramAPI {
    ...
    public struct EditMessageChecklistParams: Codable {
        /** String | Unique identifier of the business connection on behalf of which the message will be sent */
        public let business_connection_id: String
        /** Integer or String | Unique identifier for the target chat or username of the target bot in the format @username */
        public let chat_id: Either2<Int, String>
        ...
        public init(business_connection_id: String, chat_id: Either2<Int, String>, message_id: Int, checklist: InputChecklist, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_id = message_id
            self.checklist = checklist
...
extension TelegramAPI {
    ...
    public typealias EditMessageChecklistResponse = ResponseSuccess<Message>
...
extension TelegramAPI {
    ...
    public struct ApproveSuggestedPostParams: Codable {
...
extension TelegramAPI {
    ...
    public typealias ApproveSuggestedPostResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct DeclineSuggestedPostParams: Codable {
        /** Integer | Unique identifier for the target direct messages chat */
        public let chat_id: Int
        ...
        public init(chat_id: Int, message_id: Int, comment: String? = nil) {
            self.chat_id = chat_id
            self.message_id = message_id
            self.comment = comment
        }
...
extension TelegramAPI {
    ...
    public typealias DeclineSuggestedPostResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct DeleteMessageReactionParams: Codable {
        ...
        public let actor_chat_id: Int?
        
        public init(chat_id: Either2<Int, String>, message_id: Int, user_id: Int? = nil, actor_chat_id: Int? = nil) {
            self.chat_id = chat_id
            self.message_id = message_id
            self.user_id = user_id
            self.actor_chat_id = actor_chat_id
        }
    }
}
...
extension TelegramAPI {
    ...
    public typealias DeleteMessageReactionResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct DeleteAllMessageReactionsParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, user_id: Int? = nil, actor_chat_id: Int? = nil) {
            self.chat_id = chat_id
            self.user_id = user_id
            self.actor_chat_id = actor_chat_id
        }
...
extension TelegramAPI {
    ...
    public typealias DeleteAllMessageReactionsResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public typealias GetMyStarBalanceResponse = ResponseSuccess<StarAmount>
...
extension TelegramAPI {
    ...
    public struct SendGameParams: Codable {
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, game_short_name: String, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.game_short_name = game_short_name
...
extension TelegramAPI {
    ...
    public enum Either5<A: Codable, B: Codable, C: Codable, D: Codable, E: Codable>: Codable {
        case a(A)
        case b(B)
        case c(C)
        case d(D)
        ...
        public init(from decoder: Decoder) throws {
            ...
            if let value = try? container.decode(A.self) {
                ...
                throw DecodingError.typeMismatch(Either5.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for Either5"))
            }
        }
