...
extension TelegramAPI {
    ...
    */
    public struct UniqueGiftInfo: Codable {
        ...
        /** String | Origin of the gift. Currently, either "upgrade" or "transfer" */
        ...
        public init(gift: UniqueGift, origin: String, owned_gift_id: String? = nil, transfer_star_count: Int? = nil) {
            self.gift = gift
            self.origin = origin
            self.owned_gift_id = owned_gift_id
...
extension TelegramAPI {
    ...
    */
    public struct OwnedGiftUnique: Codable {
        ...
        public init(type: String, gift: UniqueGift, owned_gift_id: String? = nil, sender_user: User? = nil, send_date: Int, is_saved: Bool? = nil, can_be_transferred: Bool? = nil, transfer_star_count: Int? = nil) {
            self.type = type
            self.gift = gift
            self.owned_gift_id = owned_gift_id
            self.sender_user = sender_user
