...
extension TelegramAPI {
    ...
    */
    public struct ChatFullInfo: Codable {
        ...
        /** Boolean | Optional. True, if gifts can be sent to the chat */
        public let can_send_gift: Bool?
