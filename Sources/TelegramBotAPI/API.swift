...
extension TelegramAPI {
    ...
    */
    public struct Gift: Codable {
        ...
        public init(id: String ,sticker: Sticker ,star_count: Int ,total_count: Int? = nil ,remaining_count: Int? = nil) {
            self.id = id
            self.sticker = sticker
            self.star_count = star_count
            self.total_count = total_count
...
extension TelegramAPI {
    ...
    */
    public struct InlineQueryResultArticle: Codable {
        ...
        public init(type: String ,id: String ,title: String ,input_message_content: InputMessageContent ,reply_markup: InlineKeyboardMarkup? = nil ,url: String? = nil ,hide_url: Bool? = nil ,description: String? = nil ,thumbnail_url: String? = nil ,thumbnail_width: Int? = nil ,thumbnail_height: Int? = nil) {
            self.type = type
            self.id = id
            self.title = title
...
extension TelegramAPI {
    ...
    */
    public struct TransactionPartnerUser: Codable {
        ...
        public init(type: String ,user: User ,invoice_payload: String? = nil ,subscription_period: Int? = nil ,paid_media: Array<PaidMedia>? = nil ,paid_media_payload: String? = nil ,gift: Gift? = nil) {
            self.type = type
            self.user = user
            self.invoice_payload = invoice_payload
            self.subscription_period = subscription_period
...
extension TelegramAPI {
    ...
    public struct SendGiftParams: Codable {
        ...
        public let text_entities: Array<MessageEntity>?
        public init(user_id: Int ,gift_id: String ,text: String? = nil ,text_parse_mode: String? = nil ,text_entities: Array<MessageEntity>? = nil) {
            self.user_id = user_id
