...
extension TelegramAPI {
    ...
    public class Dice: Codable {
        ...
        /// - parameter value:  Value of the dice, 1-6 for currently supported base emoji
        ///
